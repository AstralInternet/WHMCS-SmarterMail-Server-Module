...
$_lang = [
    ...
    // ── Bouton de rafraîchissement DNS ─────────────────────────────────
    'dns_refresh_btn'      => 'Actualiser',
    'dns_refresh_busy'     => 'Vérification en cours…',
    'dns_refresh_title'    => 'Forcer une nouvelle vérification DNS (ignore le cache de 5 minutes)',
    'dns_checked_at'       => 'Dernière vérification :',
    'dns_loading'          => 'Vérification…',
    'dns_explain'          => 'Ces enregistrements aident vos courriels à être correctement reconnus, livrés et acceptés par les autres serveurs. Cliquez sur une carte pour voir les détails.',
    // ── Mini-cartes DNS — labels génériques ────────────────────────────
    'dns_card_status_ok'   => 'Configuré',
    'dns_card_status_warn' => 'Partiel',
    'dns_card_status_err'  => 'Non configuré',
    'dns_card_status_na'   => 'Non applicable',
    'dns_card_view'        => 'Voir / Configurer',
    // ── Autodiscover ────────────────────────────────────────────────────
    'autodiscover_title'         => 'Autodiscover',
    'autodiscover_subtitle'      => 'Auto-configuration des clients courriel (Outlook, Apple Mail).',
    'autodiscover_status_ok'     => 'CNAME et SRV présents',
    'autodiscover_status_warn'   => 'Configuration partielle',
    'autodiscover_status_err'    => 'Aucun enregistrement',
    'autodiscover_cname_label'   => 'CNAME / A',
    'autodiscover_srv_label'     => 'SRV',
    'autodiscover_explain'       => 'Autodiscover permet aux clients courriel de configurer automatiquement les paramètres de connexion (serveurs entrant et sortant, ports, chiffrement) à partir de l\'adresse courriel seule.',
    'autodiscover_record_cname'  => 'Enregistrement CNAME',
    'autodiscover_record_srv'    => 'Enregistrement SRV',
    'autodiscover_host_label'    => 'Hôte',
    'autodiscover_target_label'  => 'Cible',
    'autodiscover_port_label'    => 'Port',
    'autodiscover_priority_label'=> 'Priorité',
    'autodiscover_weight_label'  => 'Poids',
    'autodiscover_present'       => 'Présent',
    'autodiscover_missing'       => 'Manquant',
    // ── DMARC ───────────────────────────────────────────────────────────
    'dmarc_title'                => 'DMARC',
    'dmarc_subtitle'             => 'Politique d\'authentification courriel et rapports.',
    'dmarc_status_ok'            => 'Enregistrement présent',
    'dmarc_status_err'           => 'Aucun enregistrement',
    'dmarc_explain'              => 'DMARC indique aux serveurs de réception comment traiter les courriels qui prétendent venir de votre domaine mais qui échouent SPF/DKIM. Il fournit aussi des rapports utiles pour détecter les usurpations.',
    'dmarc_current_record'       => 'Enregistrement DMARC actuel',
    'dmarc_no_record_yet'        => 'Aucun enregistrement DMARC trouvé pour ce domaine.',
    'dmarc_open_builder'         => 'Générateur DMARC',
    'dmarc_recommended_record'   => 'Enregistrement recommandé',
    // ── Générateur DMARC ────────────────────────────────────────────────
    'dmarc_builder_title'        => 'Générateur DMARC',
    'dmarc_builder_intro'        => 'Choisissez la politique adaptée et copiez l\'enregistrement à ajouter dans votre zone DNS.',
    'dmarc_builder_policy'       => 'Politique',
    'dmarc_builder_policy_help'  => 'Action demandée aux serveurs de réception pour les courriels échouant SPF/DKIM.',
    'dmarc_builder_policy_none'      => 'Aucune (observer seulement)',
    'dmarc_builder_policy_quarantine'=> 'Quarantaine (boîte spam)',
    'dmarc_builder_policy_reject'    => 'Rejeter (bloquer)',
    'dmarc_builder_subpolicy'    => 'Politique sous-domaines',
    'dmarc_builder_subpolicy_help'=> 'Politique appliquée aux sous-domaines. Laisser vide pour reprendre la politique principale.',
    'dmarc_builder_subpolicy_inherit'=> '— Identique à la politique —',
    'dmarc_builder_adkim'        => 'Alignement DKIM',
    'dmarc_builder_aspf'         => 'Alignement SPF',
    'dmarc_builder_align_relaxed'=> 'Souple (Relaxed)',
    'dmarc_builder_align_strict' => 'Strict',
    'dmarc_builder_pct'          => 'Pourcentage',
    'dmarc_builder_pct_help'     => 'Pourcentage des courriels suspects soumis à la politique. Démarrer à 10 % puis augmenter progressivement vers 100 %.',
    'dmarc_builder_rf'           => 'Format de rapport',
    'dmarc_builder_ri'           => 'Intervalle de rapports',
    'dmarc_builder_ri_help'      => 'Intervalle minimum entre deux rapports agrégés (en secondes). 86400 = 1 jour.',
    'dmarc_builder_rua'          => 'Rapports agrégés (rua)',
    'dmarc_builder_rua_help'     => 'Adresses recevant les rapports agrégés. Plusieurs adresses possibles (séparées par des virgules).',
    'dmarc_builder_ruf'          => 'Rapports d\'échec (ruf)',
    'dmarc_builder_ruf_help'     => 'Adresses recevant les notifications individuelles d\'échec. Optionnel.',
    'dmarc_builder_preview'      => 'Aperçu de l\'enregistrement',
    'dmarc_builder_copy'         => 'Copier',
    'dmarc_builder_copied'       => 'Copié !',
    'dmarc_builder_close'        => 'Fermer',
