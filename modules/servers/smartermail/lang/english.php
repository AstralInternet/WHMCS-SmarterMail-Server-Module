...
$_lang = [
    ...
    // ── DNS refresh button ─────────────────────────────────────────────
    'dns_refresh_btn'      => 'Refresh',
    'dns_refresh_busy'     => 'Checking…',
    'dns_refresh_title'    => 'Force a fresh DNS check (bypasses 5-minute cache)',
    'dns_checked_at'       => 'Last check:',
    'dns_loading'          => 'Checking…',
    'dns_explain'          => 'These records help your emails be properly recognized, delivered, and accepted by other servers. Click any card for details.',
    // ── DNS mini-cards — generic labels ────────────────────────────────
    'dns_card_status_ok'   => 'Configured',
    'dns_card_status_warn' => 'Partial',
    'dns_card_status_err'  => 'Not configured',
    'dns_card_status_na'   => 'Not applicable',
    'dns_card_view'        => 'View / Configure',
    // ── Autodiscover ────────────────────────────────────────────────────
    'autodiscover_title'         => 'Autodiscover',
    'autodiscover_subtitle'      => 'Auto-configuration for email clients (Outlook, Apple Mail).',
    'autodiscover_status_ok'     => 'CNAME and SRV present',
    'autodiscover_status_warn'   => 'Partial configuration',
    'autodiscover_status_err'    => 'No records found',
    'autodiscover_cname_label'   => 'CNAME / A',
    'autodiscover_srv_label'     => 'SRV',
    'autodiscover_explain'       => 'Autodiscover lets email clients automatically configure connection settings (incoming/outgoing servers, ports, encryption) from just the email address.',
    'autodiscover_record_cname'  => 'CNAME record',
    'autodiscover_record_srv'    => 'SRV record',
    'autodiscover_host_label'    => 'Host',
    'autodiscover_target_label'  => 'Target',
    'autodiscover_port_label'    => 'Port',
    'autodiscover_priority_label'=> 'Priority',
    'autodiscover_weight_label'  => 'Weight',
    'autodiscover_present'       => 'Present',
    'autodiscover_missing'       => 'Missing',
    // ── DMARC ───────────────────────────────────────────────────────────
    'dmarc_title'                => 'DMARC',
    'dmarc_subtitle'             => 'Email authentication policy and reports.',
    'dmarc_status_ok'            => 'Record present',
    'dmarc_status_err'           => 'No record found',
    'dmarc_explain'              => 'DMARC tells receiving servers how to handle emails that claim to be from your domain but fail SPF/DKIM. It also provides useful reports to detect spoofing.',
    'dmarc_current_record'       => 'Current DMARC record',
    'dmarc_no_record_yet'        => 'No DMARC record found for this domain.',
    'dmarc_open_builder'         => 'DMARC Builder',
    'dmarc_recommended_record'   => 'Recommended record',
    // ── DMARC Builder ───────────────────────────────────────────────────
    'dmarc_builder_title'        => 'DMARC Builder',
    'dmarc_builder_intro'        => 'Pick the right policy and copy the record to add to your DNS zone.',
    'dmarc_builder_policy'       => 'Policy',
    'dmarc_builder_policy_help'  => 'Action requested from receiving servers for emails failing SPF/DKIM.',
    'dmarc_builder_policy_none'      => 'None (observe only)',
    'dmarc_builder_policy_quarantine'=> 'Quarantine (spam folder)',
    'dmarc_builder_policy_reject'    => 'Reject (block)',
    'dmarc_builder_subpolicy'    => 'Subdomain policy',
    'dmarc_builder_subpolicy_help'=> 'Policy applied to subdomains. Leave empty to inherit the main policy.',
    'dmarc_builder_subpolicy_inherit'=> '— Same as main policy —',
    'dmarc_builder_adkim'        => 'DKIM alignment',
    'dmarc_builder_aspf'         => 'SPF alignment',
    'dmarc_builder_align_relaxed'=> 'Relaxed',
    'dmarc_builder_align_strict' => 'Strict',
    'dmarc_builder_pct'          => 'Percentage',
    'dmarc_builder_pct_help'     => 'Percentage of suspect mail subject to the policy. Start at 10% and ramp up to 100%.',
    'dmarc_builder_rf'           => 'Report format',
    'dmarc_builder_ri'           => 'Report interval',
    'dmarc_builder_ri_help'      => 'Minimum interval between aggregate reports (seconds). 86400 = 1 day.',
    'dmarc_builder_rua'          => 'Aggregate reports (rua)',
    'dmarc_builder_rua_help'     => 'Addresses receiving aggregate reports. Multiple addresses allowed (comma-separated).',
    'dmarc_builder_ruf'          => 'Failure reports (ruf)',
    'dmarc_builder_ruf_help'     => 'Addresses receiving individual failure notifications. Optional.',
    'dmarc_builder_preview'      => 'Record preview',
    'dmarc_builder_copy'         => 'Copy',
    'dmarc_builder_copied'       => 'Copied!',
    'dmarc_builder_close'        => 'Close',
    ...
    'flash_saveautoresponder'  => 'Auto-responder saved.',
    'ar_card_title'            => 'Auto-responder',
    'ar_unavailable'           => 'The auto-responder is not available for this mailbox right now.',
    'ar_state_on'              => 'Active',
    'ar_state_scheduled'       => 'Scheduled',
    'ar_state_off'             => 'Off',
    'ar_configure'             => 'Configure',
    'ar_enable'                => 'Enable out-of-office reply',
    'ar_subject'               => 'Subject',
    'ar_message'               => 'Message',
    'ar_html_warn'             => 'The existing message is HTML; saving here will convert it to plain text.',
    'ar_direct_only'           => 'Reply only to mail sent directly to me',
    'ar_audience'              => 'External senders',
    'ar_audience_none'         => 'None (internal only)',
    'ar_audience_contacts'     => 'Known contacts',
    'ar_audience_all'          => 'Everyone',
    'ar_external'              => 'Reply for external senders',
    'ar_external_hint'         => 'Leave empty to reuse the message above.',
    'ar_use_range'             => 'Limit to a date range',
    'ar_start'                 => 'Start',
    'ar_end'                   => 'End',
    'ar_tz_hint'               => 'Times are in your local time zone.',
    'ar_save'                  => 'Save',
    'ar_err_content_required'  => 'Subject and message are required to enable the auto-responder.',
    'ar_err_dates_invalid'     => 'The active date range is invalid.',
    'ar_err_dates_order'       => 'The start date must be before the end date.',
    'ar_err_token'             => 'The auto-responder is not available for this mailbox right now.',
    'ar_err_save'              => 'Could not save the auto-responder.',
